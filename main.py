...
from tkinter import * #This is bad practice, fix this later
...
class DrawingClassifier:
    ...
    def classes_prompt(self):
        ...
        if os.path.exists(self.proj_name):
            ...
            self.class1 = simpledialog.askstring("Class 1", "What is first class called?", parent=msg)
            self.class2 = simpledialog.askstring("Class 2", "What is first class called?", parent=msg)
            self.class3 = simpledialog.askstring("Class 3", "What is first class called?", parent=msg)
    ...
    def init_gui(self):
        ...
        bm_btn.grid(row=3, column=1, sticky=W + E)
        ...
        self.status_label.config(font=("Ariel", 10))
    ...
    def save_everything(self):
        data = {"c1": self.class1, "c2": self.class2, "c3": self.class3,
                ...
                "clf": self.clf, "pname": self.prog_name}
